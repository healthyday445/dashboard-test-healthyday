...
// 2026-08-17 through 2026-08-23 ("M1W2" bucket photography)
import imgSoakedPistachiosDates from "@/assets/diet/soaked-pistachios-dates.webp";
import imgThinButtermilkWithCurryLeavesJeera from "@/assets/diet/thin-buttermilk-with-curry-leaves-jeera.webp";
import imgBajraVegetableUpma from "@/assets/diet/bajra-vegetable-upma.webp";
import imgGreenGrapes from "@/assets/diet/green-grapes.webp";
import imgRicePalakDalCarrotCoconutCurryCurd from "@/assets/diet/rice-palak-dal-carrot-coconut-curry-curd.webp";
import imgMixedVegetableSoup from "@/assets/diet/mixed-vegetable-soup.webp";
import imgGreenSaladCucumberSprouts from "@/assets/diet/green-salad-cucumber-sprouts.webp";
import imgWarmGingerHerbalTea from "@/assets/diet/warm-ginger-herbal-tea.webp";
import imgSoakedWatermelonSeeds from "@/assets/diet/soaked-watermelon-seeds.webp";
import imgGreenJuiceWithChia from "@/assets/diet/green-juice-with-chia.webp";
import imgSabudanaSaladWithPeanuts from "@/assets/diet/sabudana-salad-with-peanuts.webp";
import imgPineapple1808 from "@/assets/diet/pineapple-18-08.webp";
import imgTomatoRiceCucumberRaita from "@/assets/diet/tomato-rice-cucumber-raita.webp";
import imgRoastedSoyaChunks from "@/assets/diet/roasted-soya-chunks.webp";
import imgPlainDosaGingerChutney from "@/assets/diet/plain-dosa-ginger-chutney.webp";
import imgWarmCardamomMilk from "@/assets/diet/warm-cardamom-milk.webp";
import imgSesameSunflowerSeeds from "@/assets/diet/sesame-sunflower-seeds.webp";
import imgMixedMilletProteinVegJaava from "@/assets/diet/mixed-millet-protein-veg-jaava.webp";
import imgChapatiMoongDalTomatoCurryCurd from "@/assets/diet/chapati-moong-dal-tomato-curry-curd.webp";
import imgBoiledBlackChana from "@/assets/diet/boiled-black-chana.webp";
import imgCornSoupWithVegetables from "@/assets/diet/corn-soup-with-vegetables.webp";
import imgWarmCardamomMilk1908 from "@/assets/diet/warm-cardamom-milk-19-08.webp";
import imgPumpkinFlaxSeeds from "@/assets/diet/pumpkin-flax-seeds.webp";
import imgWarmCinnamonMilk from "@/assets/diet/warm-cinnamon-milk.webp";
import imgChickpeaGratedCoconut from "@/assets/diet/chickpea-grated-coconut.webp";
import imgBanana from "@/assets/diet/banana.webp";
import imgKorraThotakuraKichidiPotatoFryCurd from "@/assets/diet/korra-thotakura-kichidi-potato-fry-curd.webp";
import imgBoiledRajma from "@/assets/diet/boiled-rajma.webp";
import imgRagiDosaRotiPachadi from "@/assets/diet/ragi-dosa-roti-pachadi.webp";
import imgTulasiTea2008 from "@/assets/diet/tulasi-tea-20-08.webp";
import imgCashewsSoakedBlackRaisins from "@/assets/diet/cashews-soaked-black-raisins.webp";
import imgAshGourdJuice from "@/assets/diet/ash-gourd-juice.webp";
import imgRagiIdliCorianderChutney from "@/assets/diet/ragi-idli-coriander-chutney.webp";
import imgRicePumpkinDalBrinjalCurryCurd from "@/assets/diet/rice-pumpkin-dal-brinjal-curry-curd.webp";
import imgBoiledCornChaat from "@/assets/diet/boiled-corn-chaat.webp";
import imgRotiPhulkaPumpkinDalButtermilk from "@/assets/diet/roti-phulka-pumpkin-dal-buttermilk.webp";
import imgWarmNutmegMilk from "@/assets/diet/warm-nutmeg-milk.webp";
import imgMelonSeedsChiaSeeds from "@/assets/diet/melon-seeds-chia-seeds.webp";
import imgTenderCoconutWater2208 from "@/assets/diet/tender-coconut-water-22-08.webp";
import imgVegetablePoha from "@/assets/diet/vegetable-poha.webp";
import imgPineapple2208 from "@/assets/diet/pineapple-22-08.webp";
import imgMixedDalKichidiRidgeGourdCurryCurd from "@/assets/diet/mixed-dal-kichidi-ridge-gourd-curry-curd.webp";
import imgGrilledTofuPaneerCubes from "@/assets/diet/grilled-tofu-paneer-cubes.webp";
import imgCurdRiceGratedCarrotPomegranate from "@/assets/diet/curd-rice-grated-carrot-pomegranate.webp";
import imgWarmCinnamonHerbalTea from "@/assets/diet/warm-cinnamon-herbal-tea.webp";
import imgSoakedGoldenRaisins from "@/assets/diet/soaked-golden-raisins.webp";
import imgChiaSeedsWaterWithLemon from "@/assets/diet/chia-seeds-water-with-lemon.webp";
import imgEgglessBesanChillaMintChutney from "@/assets/diet/eggless-besan-chilla-mint-chutney.webp";
import imgRicePepperRasamGreenGramCurry from "@/assets/diet/rice-pepper-rasam-green-gram-curry.webp";
import imgCucumberTomatoSaladWithLemon from "@/assets/diet/cucumber-tomato-salad-with-lemon.webp";
import imgBrokenWheatUpma from "@/assets/diet/broken-wheat-upma.webp";
// 2026-08-24 through 2026-08-30 ("M1W3" bucket photography)
import img3AlmondsWalnuts from "@/assets/diet/3-almonds-walnuts.webp";
import imgAmlaMintJuice from "@/assets/diet/amla-mint-juice.webp";
import imgBeetrootCucumberPeanutSalad from "@/assets/diet/beetroot-cucumber-peanut-salad.webp";
import imgGrapes from "@/assets/diet/grapes.webp";
import imgSteamedRiceMenthiKuraPappuMullakyTomatoCurryCurd from "@/assets/diet/steamed-rice-menthi-kura-pappu-mullaky-tomato-curry-curd.webp";
import imgCorianderLemonSoup from "@/assets/diet/coriander-lemon-soup.webp";
import imgMixedVegetableUttappamMenthiKuraPappu from "@/assets/diet/mixed-vegetable-uttappam-menthi-kura-pappu.webp";
import imgCinnamonWarmMilk2408 from "@/assets/diet/cinnamon-warm-milk-24-08.webp";
import imgSesameFlaxSeeds2508 from "@/assets/diet/sesame-flax-seeds-25-08.webp";
import imgOatsPorridge from "@/assets/diet/oats-porridge.webp";
import imgBanana2508 from "@/assets/diet/banana-25-08.webp";
import imgPaneerPulaoMintRaita from "@/assets/diet/paneer-pulao-mint-raita.webp";
import imgRoastedBlackChana from "@/assets/diet/roasted-black-chana.webp";
import imgLentilMixedDalSoupOrPoha from "@/assets/diet/lentil-mixed-dal-soup-or-poha.webp";
import imgPepperMilk from "@/assets/diet/pepper-milk.webp";
import imgWarmWaterOnly from "@/assets/diet/warm-water-only.webp";
import imgWarmCardamomMilk2608 from "@/assets/diet/warm-cardamom-milk-26-08.webp";
import imgMoongDalIdliTomatoCorianderChutney from "@/assets/diet/moong-dal-idli-tomato-coriander-chutney.webp";
import imgAppleRaisins from "@/assets/diet/apple-raisins.webp";
import imgChapatiPaneerCapsicumCurry from "@/assets/diet/chapati-paneer-capsicum-curry.webp";
import imgJowarMurmuraMix from "@/assets/diet/jowar-murmura-mix.webp";
import imgMultiMilletKhichdi from "@/assets/diet/multi-millet-khichdi.webp";
import imgFennelTea2608 from "@/assets/diet/fennel-tea-26-08.webp";
import imgMixedSeedsChiaPumpkinSunflower from "@/assets/diet/mixed-seeds-chia-pumpkin-sunflower.webp";
import imgCucumberMintJuice from "@/assets/diet/cucumber-mint-juice.webp";
import imgCarrotDosaMintChutney from "@/assets/diet/carrot-dosa-mint-chutney.webp";
import imgAppleFlaxSeeds from "@/assets/diet/apple-flax-seeds.webp";
import imgJowarKhichdiHomemadeFryumsCurd from "@/assets/diet/jowar-khichdi-homemade-fryums-curd.webp";
import imgRoastedMakhana from "@/assets/diet/roasted-makhana.webp";
import imgMushroomRoll from "@/assets/diet/mushroom-roll.webp";
import imgWarmNutmegMilk2708 from "@/assets/diet/warm-nutmeg-milk-27-08.webp";
import img4Almonds4BlackRaisins from "@/assets/diet/4-almonds-4-black-raisins.webp";
import imgTenderCoconutWater2808 from "@/assets/diet/tender-coconut-water-28-08.webp";
import imgVermicelliUpmaVegetables from "@/assets/diet/vermicelli-upma-vegetables.webp";
import imgSteamedRiceGonguraPappuBeetrootCurryCurd from "@/assets/diet/steamed-rice-gongura-pappu-beetroot-curry-curd.webp";
import imgSproutsPatties from "@/assets/diet/sprouts-patties.webp";
import imgMintRiceBowlCarrotBeetRaita from "@/assets/diet/mint-rice-bowl-carrot-beet-raita.webp";
import imgCorianderSeedTea2808 from "@/assets/diet/coriander-seed-tea-28-08.webp";
import imgPumpkinSunflowerSeeds2908 from "@/assets/diet/pumpkin-sunflower-seeds-29-08.webp";
import imgSoakedChiaSeedsTenderCoconutWater from "@/assets/diet/soaked-chia-seeds-tender-coconut-water.webp";
import imgOatsCurdBowlWithNuts from "@/assets/diet/oats-curd-bowl-with-nuts.webp";
import imgRiceMixedDalCurryCucumberBoiledPeanutSalad2908 from "@/assets/diet/rice-mixed-dal-curry-cucumber-boiled-peanut-salad-29-08.webp";
import imgPaneerCubesPepper2908 from "@/assets/diet/paneer-cubes-pepper-29-08.webp";
import imgCurdPoha from "@/assets/diet/curd-poha.webp";
import imgAjwainTea2908 from "@/assets/diet/ajwain-tea-29-08.webp";
import img3Pistachios5GoldRaisins from "@/assets/diet/3-pistachios-5-gold-raisins.webp";
import imgCorianderLemonButtermilk from "@/assets/diet/coriander-lemon-buttermilk.webp";
import imgFoxtailMilletPongalTomatoChutney from "@/assets/diet/foxtail-millet-pongal-tomato-chutney.webp";
import imgRiceGingerRasamPaneerVegCurry from "@/assets/diet/rice-ginger-rasam-paneer-veg-curry.webp";
import imgBoiledPeanutsBlackChanaVeggies from "@/assets/diet/boiled-peanuts-black-chana-veggies.webp";
import imgChickpeaMintSpreadRoll from "@/assets/diet/chickpea-mint-spread-roll.webp";
import imgChamomileTea from "@/assets/diet/chamomile-tea.webp";
// 2026-08-31 through 2026-09-06 ("M1W4" — sourced from the meal-images bucket by meal_id)
import imgM15Meal from "@/assets/diet/m1w4/m15.webp";
import imgM27Meal from "@/assets/diet/m1w4/m27.webp";
import imgM30Meal from "@/assets/diet/m1w4/m30.webp";
import imgM47Meal from "@/assets/diet/m1w4/m47.webp";
import imgM48Meal from "@/assets/diet/m1w4/m48.webp";
import imgM63Meal from "@/assets/diet/m1w4/m63.webp";
import imgM74Meal from "@/assets/diet/m1w4/m74.webp";
import imgM76Meal from "@/assets/diet/m1w4/m76.webp";
import imgM80Meal from "@/assets/diet/m1w4/m80.webp";
import imgM87Meal from "@/assets/diet/m1w4/m87.webp";
import imgM111Meal from "@/assets/diet/m1w4/m111.webp";
import imgM112Meal from "@/assets/diet/m1w4/m112.webp";
import imgM119Meal from "@/assets/diet/m1w4/m119.webp";
import imgM120Meal from "@/assets/diet/m1w4/m120.webp";
import imgM124Meal from "@/assets/diet/m1w4/m124.webp";
import imgM132Meal from "@/assets/diet/m1w4/m132.webp";
import imgM138Meal from "@/assets/diet/m1w4/m138.webp";
import imgM143Meal from "@/assets/diet/m1w4/m143.webp";
import imgM144Meal from "@/assets/diet/m1w4/m144.webp";
import imgM145Meal from "@/assets/diet/m1w4/m145.webp";
import imgM146Meal from "@/assets/diet/m1w4/m146.webp";
import imgM148Meal from "@/assets/diet/m1w4/m148.webp";
import imgM149Meal from "@/assets/diet/m1w4/m149.webp";
import imgM150Meal from "@/assets/diet/m1w4/m150.webp";
import imgM151Meal from "@/assets/diet/m1w4/m151.webp";
import imgM152Meal from "@/assets/diet/m1w4/m152.webp";
import imgM153Meal from "@/assets/diet/m1w4/m153.webp";
import imgM154Meal from "@/assets/diet/m1w4/m154.webp";
import imgM155Meal from "@/assets/diet/m1w4/m155.webp";
import imgM156Meal from "@/assets/diet/m1w4/m156.webp";
import imgM157Meal from "@/assets/diet/m1w4/m157.webp";
import imgM158Meal from "@/assets/diet/m1w4/m158.webp";
import imgM160Meal from "@/assets/diet/m1w4/m160.webp";
import imgM161Meal from "@/assets/diet/m1w4/m161.webp";
import imgM162Meal from "@/assets/diet/m1w4/m162.webp";
import imgM163Meal from "@/assets/diet/m1w4/m163.webp";
import imgM164Meal from "@/assets/diet/m1w4/m164.webp";
import imgM165Meal from "@/assets/diet/m1w4/m165.webp";
import imgM166Meal from "@/assets/diet/m1w4/m166.webp";
import imgM167Meal from "@/assets/diet/m1w4/m167.webp";
import imgM169Meal from "@/assets/diet/m1w4/m169.webp";
import imgM170Meal from "@/assets/diet/m1w4/m170.webp";
import imgM171Meal from "@/assets/diet/m1w4/m171.webp";
import imgM172Meal from "@/assets/diet/m1w4/m172.webp";
import imgM173Meal from "@/assets/diet/m1w4/m173.webp";
import imgM174Meal from "@/assets/diet/m1w4/m174.webp";
import imgM175Meal from "@/assets/diet/m1w4/m175.webp";
...
"2026-08-17": {
    earlyMorning: {
      ...
      imageUrl: imgSoakedPistachiosDates,
      ...
      recommendedQuantity: [
        { ingredient: t("Pistachios", "పిస్తా"), qty: same("3") },
        { ingredient: t("Dates", "ఖర్జూరం"), qty: same("2") },
      ],
      nutritionalBenefits: [
    ...
    postYogaDrink: {
      ...
      imageUrl: imgThinButtermilkWithCurryLeavesJeera,
      ...
      recommendedQuantity: [
        { ingredient: same("Buttermilk"), qty: same("1 glass") },
        { ingredient: t("Jeera", "జీలకర్ర"), qty: same("a pinch") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Curd", "పెరుగు"), benefits: [{ benefitLabel: t("Gut Health", "Gut health కి మంచిది"), iconKey: "stomach" }] },
      ],
    ...
    breakfast: {
      ...
      imageUrl: imgBajraVegetableUpma,
      ...
      recommendedQuantity: [
        { ingredient: same("Upma"), qty: same("1 medium bowl") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
    ...
    morningSnack: {
      ...
      recommendedQuantity: [{ ingredient: t("Green Grapes", " ద్రాక్ష"), qty: same("1 small cup") }],
      nutritionalBenefits: [
    ...
    lunch: {
      ...
      imageUrl: imgRicePalakDalCarrotCoconutCurryCurd,
      ...
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: t("Dal", "పప్పు"), qty: same("1 cup") },
        { ingredient: same("Curry"), qty: same("1 cup") },
        { ingredient: t("Curd", "పెరుగు"), qty: same("3 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: same("Rice"), benefits: [{ benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" }] },
    ...
    eveningSnack: {
      ...
      imageUrl: imgMixedVegetableSoup,
      ...
      recommendedQuantity: [{ ingredient: t("Mixed Vegetable Soup", "Mixed vegetable సూప్"), qty: same("1 medium bowl") }],
      nutritionalBenefits: [
        { ingredient: t("Mixed Vegetables", "Mixed వెజిటబుల్స్"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
      ],
      groceryListAvailable: true,
    ...
    dinner: {
      ...
      imageUrl: imgGreenSaladCucumberSprouts,
      ...
      recommendedQuantity: [
        { ingredient: same("Salad"), qty: same("1 cup") },
        { ingredient: t("Sprouts", "మొలకలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
    ...
    nightDrink: {
      ...
      imageUrl: imgWarmGingerHerbalTea,
      ...
      recommendedQuantity: [{ ingredient: same("Ginger Tea"), qty: same("1 cup") }],
      nutritionalBenefits: [
  ...
  "2026-08-18": {
    earlyMorning: {
      ...
      imageUrl: imgSoakedWatermelonSeeds,
      items: [{ label: same("1 tbsp") }],
    ...
    postYogaDrink: {
      ...
      imageUrl: imgGreenJuiceWithChia,
      tips: t(
      ...
      recommendedQuantity: [
        { ingredient: t("Spinach", "పాలకూర"), qty: same("1 cup") },
        { ingredient: t("Mint", "పుదీనా"), qty: same("1/4 cup") },
        { ingredient: t("Lemon", "నిమ్మకాయ"), qty: same("1/2") },
        { ingredient: same("Chia"), qty: same("1 tsp") },
        { ingredient: t("Water", "గోరువెచ్చని నీరు"), qty: same("150 ml") },
      ],
      nutritionalBenefits: [
    ...
    breakfast: {
      ...
      imageUrl: imgSabudanaSaladWithPeanuts,
      tips: t(
      ...
      recommendedQuantity: [
        { ingredient: same("Cooked Sabudana"), qty: same("1 medium cup") },
        { ingredient: t("Peanuts", "పల్లీలు"), qty: same("1 tbsp") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
    ...
    morningSnack: {
      ...
      recommendedQuantity: [{ ingredient: same("Pineapple"), qty: same("1 small cup") }],
      nutritionalBenefits: [
    ...
    lunch: {
      ...
      imageUrl: imgTomatoRiceCucumberRaita,
      ...
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: same("Raita"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
    ...
    eveningSnack: {
      ...
      recommendedQuantity: [{ ingredient: same("Cooked Soya"), qty: same("1 cup") }],
      nutritionalBenefits: [
    ...
    dinner: {
      ...
      imageUrl: imgPlainDosaGingerChutney,
      ...
      recommendedQuantity: [
        { ingredient: t("Dosa", "దోస"), qty: same("2 small") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Ginger", "అల్లం"), benefits: [
          { benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" },
    ...
    nightDrink: {
      ...
      recommendedQuantity: [
        { ingredient: t("Milk", "పాలు"), qty: same("1 cup") },
        { ingredient: t("Cardamom", "యాలకులు"), qty: same("a pinch") },
      ],
      nutritionalBenefits: [
  ...
  "2026-08-19": {
    earlyMorning: {
      ...
      imageUrl: imgSesameSunflowerSeeds,
      ...
      recommendedQuantity: [
        { ingredient: same("Sesame"), qty: same("1 tbsp") },
        { ingredient: t("Sunflower Seeds", "Sunflower గింజలు"), qty: same("1 tbsp") },
      ],
      nutritionalBenefits: [
    ...
    breakfast: {
      ...
      imageUrl: imgMixedMilletProteinVegJaava,
      tips: t(
      ...
      recommendedQuantity: [
        { ingredient: same("Java"), qty: same("1 medium cup") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Millet", "మిల్లెట్స్"), benefits: [
    ...
    lunch: {
      ...
      imageUrl: imgChapatiMoongDalTomatoCurryCurd,
      precautions: t(
      ...
      recommendedQuantity: [
        { ingredient: t("Chapati", "చపాతీ"), qty: same("2 small") },
        { ingredient: same("Dal/Egg"), qty: same("1 cup") },
        { ingredient: t("Curd", "పెరుగు"), qty: same("3 tbsp") },
      ],
      nutritionalBenefits: [
    ...
    eveningSnack: {
      ...
      recommendedQuantity: [{ ingredient: t("Black Chana", "నల్ల శనగలు"), qty: same("1/2-1 cup") }],
      nutritionalBenefits: [
    ...
    dinner: {
      ...
      imageUrl: imgCornSoupWithVegetables,
      ...
      recommendedQuantity: [
        { ingredient: same("Soup"), qty: same("1 medium bowl") },
        { ingredient: t("Corn", "మొక్కజొన్న"), qty: same("1/2 cup") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Corn", "మొక్కజొన్న"), benefits: [
    ...
    nightDrink: {
      name: t("Warm Cardamom Milk", " యాలకుల పాలు"),
      imageUrl: imgWarmCardamomMilk1908,
      tips: t("Take 1 cup warm milk with a pinch of cardamom.", "1 cup warm milk లో a pinch యాలకుల పొడి వేసుకుని తీసుకోండి."),
      precautions: t("For diabetes or PCOS, do not add sugar or jaggery.", "Diabetes లేదా PCOS ఉన్నవారు sugar లేదా jaggery add చేయకండి."),
      recommendedQuantity: [
        { ingredient: t("Milk", "పాలు"), qty: same("1 cup") },
  ...
  "2026-08-20": {
    earlyMorning: {
      ...
      imageUrl: imgPumpkinFlaxSeeds,
      items: [{ label: same("1 tbsp Pumpkin Seeds") }, { label: same("1 tbsp Flax Seeds") }],
      tips: t(
        "Take 1 tbsp pumpkin seeds & flax seeds and soak all the night.",
        "1 tbsp గుమ్మడి గింజలు &  అవిసె గింజలు night soak చేసి తీసుకోండి."
      ),
      precautions: t(
      ...
      recommendedQuantity: [
        { ingredient: t("Pumpkin Seeds", "గుమ్మడి గింజలు"), qty: same("1 tbsp") },
        { ingredient: t("Flax Seeds", "అవిసె గింజలు"), qty: same("1 tbsp") },
      ],
      nutritionalBenefits: [
    ...
    postYogaDrink: {
      ...
      imageUrl: imgWarmCinnamonMilk,
      precautions: t("For diabetes or PCOS, do not add sugar or jaggery.", "Diabetes లేదా PCOS ఉన్నవారు sugar లేదా jaggery add చేయకండి."),
      recommendedQuantity: [
        { ingredient: t("Milk", "పాలు"), qty: same("1 cup") },
        { ingredient: t("Cinnamon", "దాల్చిన చెక్క"), qty: same("a pinch") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Cinnamon", "దాల్చిన చెక్క"), benefits: [
    ...
    breakfast: {
      ...
      imageUrl: imgChickpeaGratedCoconut,
      ...
      recommendedQuantity: [
        { ingredient: same("Chickpeas"), qty: same("1 cup") },
        { ingredient: t("Coconut", "కొబ్బరి"), qty: same("1 tbsp") },
      ],
      nutritionalBenefits: [
    ...
    morningSnack: {
      ...
      recommendedQuantity: [{ ingredient: t("Banana", "అరటిపండు"), qty: same("1 small-medium") }],
      nutritionalBenefits: [
    ...
    lunch: {
      ...
      imageUrl: imgKorraThotakuraKichidiPotatoFryCurd,
      ...
      recommendedQuantity: [
        { ingredient: same("Khichidi"), qty: same("1 medium cup") },
        { ingredient: same("Potato/Chicken"), qty: same("1/2 cup") },
        { ingredient: t("Curd", "పెరుగు"), qty: same("3 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Millet", "మిల్లెట్స్"), benefits: [
    ...
    eveningSnack: {
      ...
      precautions: t("If you have gas/bloating, start with 1/2 cup.", "Gas/bloating ఉంటే 1/2 cup తో start చేయండి."),
      recommendedQuantity: [{ ingredient: t("Rajma", "రాజ్మా"), qty: same("1/2-1 cup") }],
      nutritionalBenefits: [
        { ingredient: t("Rajma", "రాజ్మా"), benefits: [
          { benefitLabel: t("Protein-Rich", "Protein ఎక్కువగా ఉంటుంది"), iconKey: "muscle-health" },
          { benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" },
    ...
    dinner: {
      ...
      imageUrl: imgRagiDosaRotiPachadi,
      precautions: t(
  ...
  "2026-08-21": {
    earlyMorning: {
      ...
      imageUrl: imgCashewsSoakedBlackRaisins,
      ...
      recommendedQuantity: [
        { ingredient: t("Cashews", "జీడిపప్పు"), qty: same("4") },
        { ingredient: t("Black Raisins", "నల్ల ఎండు ద్రాక్ష"), qty: same("5") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Cashews", "జీడిపప్పు"), benefits: [{ benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" }] },
    ...
    postYogaDrink: {
      ...
      recommendedQuantity: [{ ingredient: t("Ash Gourd Juice", "బూడిద గుమ్మడికాయ juice"), qty: same("1 small glass") }],
      nutritionalBenefits: [
    ...
    breakfast: {
      ...
      imageUrl: imgRagiIdliCorianderChutney,
      tips: t(
      ...
      recommendedQuantity: [
        { ingredient: same("Ragi Idli"), qty: same("3") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Ragi", "రాగి"), benefits: [{ benefitLabel: t("Bone Health", "Bone health కి మంచిది"), iconKey: "dog-bone" }] },
    ...
    lunch: {
      ...
      imageUrl: imgRicePumpkinDalBrinjalCurryCurd,
      tips: t(
    ...
    eveningSnack: {
      ...
      recommendedQuantity: [
        { ingredient: t("Corn", "మొక్కజొన్న"), qty: same("1 cup") },
        { ingredient: same("Onion"), qty: same("2 tbsp") },
        { ingredient: t("Lemon", "నిమ్మకాయ"), qty: same("1/2") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Corn", "మొక్కజొన్న"), benefits: [
  ...
  "2026-08-22": {
    earlyMorning: {
      ...
      imageUrl: imgMelonSeedsChiaSeeds,
      items: [{ label: same("1 tbsp Melon Seeds") }, { label: same("1 tsp Chia Seeds") }],
      tips: t(
        "Soak chia and watermelon seeds all the night well.",
        "1 tsp chia seeds ని, 1 tbsp melon seeds ని night బాగా soak చేసి తీసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: same("Melon Seeds"), qty: same("1 tbsp") },
        { ingredient: same("Chia"), qty: same("1 tsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Watermelon Seeds", "పుచ్చకాయ గింజలు"), benefits: [
    ...
    postYogaDrink: {
      name: same("Tender Coconut Water"),
      imageUrl: imgTenderCoconutWater2208,
      precautions: t(
        "For people with Diabetes, limit the quantity as coconut water contains natural sugars.",
        "Diabetes ఉన్నవారు కొబ్బరి నీరు ని Limit గా తీసుకోండి. ఇందులో natural sugars ఉంటాయి"
      ),
      recommendedQuantity: [{ ingredient: t("Tender Coconut Water", "కొబ్బరి నీరు"), qty: same("1 glass") }],
      nutritionalBenefits: [
    ...
    breakfast: {
      ...
      recommendedQuantity: [
        { ingredient: t("Poha", "అటుకులు"), qty: same("1 medium bowl") },
        { ingredient: t("Peanuts", "పల్లీలు"), qty: same("1 tbsp") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
    ...
    lunch: {
      ...
      imageUrl: imgMixedDalKichidiRidgeGourdCurryCurd,
    ...
    eveningSnack: {
      ...
      imageUrl: imgGrilledTofuPaneerCubes,
      ...
      recommendedQuantity: [{ ingredient: t("Paneer", "పనీర్"), qty: same("30-40 g") }],
      nutritionalBenefits: [
        { ingredient: t("Paneer", "పనీర్"), benefits: [{ benefitLabel: t("Muscle Health", "Muscle health ని పెంచుతుంది"), iconKey: "muscle-health" }] },
      ],
      groceryListAvailable: true,
    ...
    dinner: {
      ...
      imageUrl: imgCurdRiceGratedCarrotPomegranate,
      tips: t(
      ...
      recommendedQuantity: [
        { ingredient: same("Curd Rice"), qty: same("1 medium cup") },
        { ingredient: t("Carrot", "క్యారెట్"), qty: same("1/2 cup") },
        { ingredient: t("Pomegranate", "దానిమ్మ"), qty: same("2 tbsp") },
      ],
      nutritionalBenefits: [
    ...
    nightDrink: {
      ...
      imageUrl: imgWarmCinnamonHerbalTea,
      precautions: t("Avoid sugar or honey, especially if you have diabetes.", "Diabetes ఉన్నవారు sugar లేదా honey add చేయకండి."),
      recommendedQuantity: [{ ingredient: same("Cinnamon Tea"), qty: same("1 cup") }],
      nutritionalBenefits: [
        { ingredient: t("Cinnamon", "దాల్చిన చెక్క"), benefits: [
          { benefitLabel: t("Healthy Blood Sugar", "Blood sugar levels ని manage చేస్తుంది."), iconKey: "sugar-cubes" },
          { benefitLabel: t("Healthy Metabolism", "Metabolism ని పెంచుతుంది"), iconKey: "healthy-eating" },
  ...
  "2026-08-23": {
    earlyMorning: {
      ...
      imageUrl: imgSoakedGoldenRaisins,
      items: [{ label: same("5 Raisins") }],
      precautions: t(
      ...
      recommendedQuantity: [{ ingredient: t("Raisins", "ఎండు ద్రాక్ష"), qty: same("5") }],
      nutritionalBenefits: [
        { ingredient: t("Raisins", "ఎండు ద్రాక్ష"), benefits: [
          { benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" },
          { benefitLabel: t("Supports Hemoglobin", "Hemoglobin ని పెంచుతుంది"), iconKey: "hemoglobin" },
    ...
    postYogaDrink: {
      ...
      imageUrl: imgChiaSeedsWaterWithLemon,
      precautions: t(
      ...
      recommendedQuantity: [
        { ingredient: same("Chia"), qty: same("1 tsp") },
        { ingredient: t("Water", "గోరువెచ్చని నీరు"), qty: same("1 glass") },
        { ingredient: t("Lemon", "నిమ్మకాయ"), qty: same("1/2") },
      ],
      nutritionalBenefits: [
    ...
    lunch: {
      ...
      imageUrl: imgRicePepperRasamGreenGramCurry,
      tips: t("Take more green gram curry and vegetables.", "పెసలు కూర మరియు vegetables ఎక్కువగా తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: t("Rasam", "రసం"), qty: same("1 cup") },
        { ingredient: same("Green Gram Curry"), qty: same("1 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: same("Rice"), benefits: [{ benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" }] },
    ...
    eveningSnack: {
      ...
      imageUrl: imgCucumberTomatoSaladWithLemon,
      ...
      recommendedQuantity: [{ ingredient: same("Salad"), qty: same("1 cup") }],
      nutritionalBenefits: [
        { ingredient: t("Cucumber", "కీరదోసకాయ"), benefits: [
          { benefitLabel: t("Hydration", "Body ని Hydrated గా ఉంచుతుంది"), iconKey: "water" },
          { benefitLabel: t("Cooling", "Body న్ని cool గా ఉంచుతుంది"), iconKey: "snowflake", visibleLanguages: ["English"] },
    ...
    dinner: {
      ...
      imageUrl: imgBrokenWheatUpma,
      precautions: t(
        "For diabetes keep the portion moderate and add more vegetables.",
        "Diabetes ఉన్నవారు portion moderate గా ఉంచి vegetables ఎక్కువగా తీసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Broken wheat upma", "పల్లీలతో గోధుమ రవ్వ ఉప్మా"), qty: same("1 medium bowl") },
        { ingredient: t("Peanuts", "పల్లీలు"), qty: same("1 tbsp") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      groceryListAvailable: true,
...
"2026-08-24": {
    earlyMorning: {
      name: t("3 Almonds & 2 Walnuts", "3 బాదం & 2 walnuts"),
      imageUrl: img3AlmondsWalnuts,
      items: [{ label: same("3 Almonds") }, { label: same("2 Walnuts") }],
      tips: t("Soak in the night and take in the morning.", "Night soak చేసి morning తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Almonds", "బాదం"), qty: same("3") },
        { ingredient: same("Walnuts"), qty: same("2") },
      ],
      nutritionalBenefits: [
        { ingredient: same("Walnuts"), benefits: [{ benefitLabel: t("Heart Health", "Heart health కి మంచిది"), iconKey: "heart" }] },
        { ingredient: t("Almonds", "బాదం"), benefits: [
    ...
    postYogaDrink: {
      name: t("Amla, Mint Juice", "ఉసిరి, పుదీనా Juice"),
      imageUrl: imgAmlaMintJuice,
      tips: t("Take it fresh without sugar or honey.", "Fresh గా sugar లేదా honey లేకుండా తీసుకోండి."),
      recommendedQuantity: [{ ingredient: same("Juice"), qty: same("1 small glass") }],
      nutritionalBenefits: [
        { ingredient: t("Amla Water", "ఉసిరి నీళ్లు"), benefits: [{ benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" }] },
      ],
      groceryListAvailable: true,
    ...
    breakfast: {
      name: t("Beetroot, Cucumber, Peanut Salad", "బీట్‌రూట్, కీరదోసకాయ, పల్లీ సలాడ్"),
      imageUrl: imgBeetrootCucumberPeanutSalad,
      precautions: t("For thyroid concerns, keep peanuts to 1–2 tbsp.", "Thyroid ఉన్నవారు peanuts ని 1–2 tbsp వరకు ఉంచండి."),
      recommendedQuantity: [
        { ingredient: same("Salad"), qty: same("1 cup") },
        { ingredient: t("Peanuts", "పల్లీలు"), qty: same("1 tbsp") },
      ],
    ...
    morningSnack: {
      // Sheet's day-schedule tab gives the Telugu dish name with a leading space —
      // transcribed verbatim, not trimmed.
      name: t("Grapes", " ద్రాక్ష"),
      imageUrl: imgGrapes,
      items: [{ label: same("1 Cup") }],
      tips: t("Take about 1 cup green grapes as a whole fruit.", "సుమారు 1 cup పచ్చ ద్రాక్షను whole fruit గా తీసుకోండి."),
      precautions: t("If you have diabetes, keep the portion to about 1/2 cup.", "Diabetes ఉన్నవారు సుమారు 1/2 cup వరకే తీసుకోండి."),
      recommendedQuantity: [{ ingredient: t("Grapes", " ద్రాక్ష"), qty: same("1 small cup") }],
      nutritionalBenefits: [
        { ingredient: t("Green Grapes", "పచ్చ ద్రాక్ష"), benefits: [
          { benefitLabel: t("Hydration", "Body ని Hydrated గా ఉంచుతుంది"), iconKey: "water" },
          { benefitLabel: t("Antioxidant Protection", "Immunity ని పెంచుతుంది"), iconKey: "healthy-food" },
    ...
    lunch: {
      name: t(
        "Steamed Rice, Menthi Kura Pappu, Mullaky Tomato Curry, Curd",
        "అన్నం, మెంతికూర పప్పు, ములక్కాయ టమాటా కూర, పెరుగు"
      ),
      imageUrl: imgSteamedRiceMenthiKuraPappuMullakyTomatoCurryCurd,
      tips: t(
        "Keep the portion as given and add more vegetables where possible.",
        "Given portion లో తీసుకుని వీలైతే vegetables ఎక్కువగా add చేసుకోండి."
      ),
      precautions: t(
        "For diabetes, keep cooked rice/grain around 150 g; for BP, keep salt low.",
        "Diabetes ఉన్నవారు cooked rice/grain సుమారు 150 g వరకే తీసుకోండి; BP ఉన్నవారు salt తక్కువగా ఉంచండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: t("Dal", "పప్పు"), qty: same("1 cup") },
      ...
      nutritionalBenefits: [
        { ingredient: t("Methi", "మెంతి కూర"), benefits: [{ benefitLabel: t("Reduces Cholesterol", "Cholesterol ని తగ్గిస్తుంది."), iconKey: "allergen-free" }] },
        { ingredient: t("Drumstick", "మునక్కాయ"), benefits: [
          { benefitLabel: t("Manages Blood Sugar levels", "Blood sugar levels ని manage చేస్తుంది."), iconKey: "sugar-cubes" },
          { benefitLabel: t("Gut Health", "Gut health కి మంచిది"), iconKey: "stomach" },
        ] },
      ],
    ...
    eveningSnack: {
      name: t("Coriander Lemon Soup", "కొత్తిమీర  soup"),
      imageUrl: imgCorianderLemonSoup,
      tips: t("Use less oil and keep the portion as given.", "Oil తక్కువగా వాడి limit portion లో తీసుకోండి."),
      recommendedQuantity: [{ ingredient: same("Soup"), qty: same("1 medium bowl") }],
      nutritionalBenefits: [
        { ingredient: t("Lemon", "నిమ్మకాయ"), benefits: [{ benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" }] },
      ],
      groceryListAvailable: true,
    ...
    dinner: {
      name: t("Mixed Vegetable Uttappam, Menthi Kura Pappu", "మిక్స్‌డ్ వెజిటబుల్ ఉత్తప్పం, మెంతికూర పప్పు"),
      imageUrl: imgMixedVegetableUttappamMenthiKuraPappu,
      tips: t("Use ONLY 1/2 tsp oil for one serving", "1 Utthappam  - Oil 1/2 tsp తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Uttappam", "ఉత్తప్పం"), qty: same("2 small") },
        { ingredient: t("Dal", "పప్పు"), qty: same("1/2-1 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Mixed Vegetables", "Mixed వెజిటబుల్స్"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
        { ingredient: t("Methi", "మెంతి కూర"), benefits: [{ benefitLabel: t("Reduces Cholesterol", "Cholesterol ని తగ్గిస్తుంది."), iconKey: "allergen-free" }] },
    ...
    nightDrink: {
      name: t("Cinnamon Warm Milk", "దాల్చిన చెక్క పాలు"),
      imageUrl: imgCinnamonWarmMilk2408,
      tips: t("Take 1 cup warm milk with a pinch of cinnamon.", "1 cup warm milk లో a pinch దాల్చిన చెక్క powder వేసుకుని తీసుకోండి."),
      precautions: t("For diabetes or PCOS, do not add sugar or jaggery.", "Diabetes లేదా PCOS ఉన్నవారు sugar లేదా jaggery add చేయకండి."),
      recommendedQuantity: [
        { ingredient: t("Milk", "పాలు"), qty: same("1 cup") },
        { ingredient: t("Cinnamon", "దాల్చిన చెక్క"), qty: same("a pinch") },
  ...
  // 2026-08-25 has no distinct Post Yoga Drink card — see `OMITTED_SLOTS_BY_DATE` below.
  "2026-08-25": {
    earlyMorning: {
      name: t("Sesame, Flax Seeds", "నువ్వులు, అవిసె గింజలు"),
      imageUrl: imgSesameFlaxSeeds2508,
      items: [{ label: same("2 tbsp Total") }],
      tips: t("Soak where mentioned and take in the morning.", "Night soak చేసి morning తీసుకోండి."),
      recommendedQuantity: [{ ingredient: same("Seeds"), qty: same("2 tbsp total") }],
      nutritionalBenefits: [
        { ingredient: t("Flax Seeds", "అవిసె గింజలు"), benefits: [{ benefitLabel: t("Heart Health", "Heart health కి మంచిది"), iconKey: "heart" }] },
        { ingredient: t("Sesame Seeds", "నువ్వులు"), benefits: [{ benefitLabel: t("Bone Health", "Bone health కి మంచిది"), iconKey: "dog-bone" }] },
      ],
    ...
    breakfast: {
      name: t("Oats Porridge", "ఓట్స్ Porridge"),
      imageUrl: imgOatsPorridge,
      tips: t(
        "Cook 30 g oats with 100 ml milk until soft, then add 1 tbsp nuts & seeds and top with any fruit.",
        "30 g oats ని 100 ml milk తో soft గా cook చేసి, 1 tbsp nuts & seeds add చేసి, పైన any fruit add చేసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Oats", "ఓట్స్"), qty: same("30 g") },
        { ingredient: t("Milk", "పాలు"), qty: same("100 ml") },
        { ingredient: same("Nuts And Seeds"), qty: same("1 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Oats", "ఓట్స్"), benefits: [
          { benefitLabel: t("Manages Blood Sugar levels", "Blood sugar levels ని manage చేస్తుంది."), iconKey: "sugar-cubes" },
          { benefitLabel: t("Reduces Cholesterol", "Cholesterol ని తగ్గిస్తుంది."), iconKey: "allergen-free" },
        ] },
      ],
      groceryListAvailable: true,
    },
    ...
    lunch: {
      name: t("Paneer Pulao, Mint Raita", "పనీర్ పులావ్, పుదీనా raita"),
      imageUrl: imgPaneerPulaoMintRaita,
      precautions: t(
        "For diabetes, keep cooked rice/grain around 150 g;",
        "Diabetes ఉన్నవారు cooked rice/grain సుమారు 150 g వరకే తీసుకోండి"
      ),
      recommendedQuantity: [
        { ingredient: same("Pulao"), qty: same("1 medium cup") },
        { ingredient: same("Raita"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Paneer", "పనీర్"), benefits: [{ benefitLabel: t("Muscle Health", "Muscle health ని పెంచుతుంది"), iconKey: "muscle-health" }] },
        { ingredient: same("Mint"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }], visibleLanguages: ["English"] },
      ],
      groceryListAvailable: true,
    },
    eveningSnack: {
      name: t("Roasted Black Chana", "వేపిన నల్ల శనగలు"),
      imageUrl: imgRoastedBlackChana,
      items: [{ label: same("1/2 CUP (30 - 40 GMS)") }],
      precautions: t("If you have gas or bloating, start with a smaller portion.", "Gas లేదా bloating ఉంటే చిన్న portion తో start చేయండి."),
      recommendedQuantity: [{ ingredient: same("Roaste Black Chana"), qty: same("30-40 g") }],
      nutritionalBenefits: [
        { ingredient: t("Black Chana", "నల్ల శనగలు"), benefits: [
          { benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" },
          { benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" },
    ...
    dinner: {
      name: t("Lentil (Masoor / Mixed Dal) Soup or Poha", "Mixed dal  సూప్ / అటుకులు"),
      imageUrl: imgLentilMixedDalSoupOrPoha,
      tips: t(
        "Keep the portion as given and add more vegetables where possible.",
        "Given portion లో తీసుకుని వీలైతే vegetables ఎక్కువగా add చేసుకోండి."
      ),
    ...
    nightDrink: {
      name: t("Pepper Milk", "మిరియాల పాలు"),
      imageUrl: imgPepperMilk,
      tips: t("Take it warm without sugar.", "Warm గా sugar లేకుండా తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Milk", "పాలు"), qty: same("1 cup") },
        { ingredient: t("Pepper", "మిరియాలు"), qty: same("a pinch") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Pepper", "మిరియాలు"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
      ],
  ...
  "2026-08-26": {
    earlyMorning: {
      // Schedule tab's Telugu name ("గోరువెచ్చని నీళ్లు") differs from the per-meal detail
      // tab's ("వెచ్చని నీళ్లు") for this same meal_id — using the schedule tab's name, per
      // this file's convention of the day-schedule cell governing the displayed dish name.
      name: t("Warm Water Only", "గోరువెచ్చని నీళ్లు"),
      imageUrl: imgWarmWaterOnly,
      items: [{ label: same("1 Glass") }],
      recommendedQuantity: [{ ingredient: t("Water", "గోరువెచ్చని నీరు"), qty: same("1 glass") }],
      nutritionalBenefits: [
        { ingredient: t("Warm Water", "వెచ్చని నీళ్లు"), benefits: [
          { benefitLabel: t("Bone Health", "Bone health కి మంచిది"), iconKey: "dog-bone" },
          { benefitLabel: t("Healthy Metabolism", "Metabolism ని పెంచుతుంది"), iconKey: "healthy-eating" },
        ] },
      ],
    ...
    postYogaDrink: {
      name: t("Warm Cardamom Milk", " యాలకుల పాలు"),
      imageUrl: imgWarmCardamomMilk2608,
      tips: t("Take 1 cup warm milk with a pinch of cardamom.", "1 cup warm milk లో a pinch యాలకుల పొడి వేసుకుని తీసుకోండి."),
      precautions: t("For diabetes or PCOS, do not add sugar or jaggery.", "Diabetes లేదా PCOS ఉన్నవారు sugar లేదా jaggery add చేయకండి."),
      recommendedQuantity: [
        { ingredient: t("Milk", "పాలు"), qty: same("1 cup") },
    ...
    breakfast: {
      name: t("Moong Dal Idli, Tomato Coriander Chutney", "పెసరపప్పు ఇడ్లీ, టమాటా కొత్తిమీర చట్నీ"),
      imageUrl: imgMoongDalIdliTomatoCorianderChutney,
      precautions: t(
        "For kidney concerns, you can avoid tomato and add any other suitable vegetable instead.",
        "Kidney issue ఉన్నవారు tomato avoid చేసి, దాని బదులు ఏదైనా vegetable add చేసుకోవచ్చు."
      ),
      recommendedQuantity: [
        { ingredient: same("Idli"), qty: same("3 medium") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Moong", "పెసరపప్పు"), benefits: [
    ...
    morningSnack: {
      name: t("Apple, Raisins", "Apple, ఎండు ద్రాక్ష"),
      imageUrl: imgAppleRaisins,
      items: [{ label: same("1 Medium Apple") }, { label: same("5 Raisins") }],
      precautions: t("For diabetes, keep the portion as given and avoid honey.", "Diabetes ఉన్నవారు limit లోనే తీసుకుని honey avoid చేయండి."),
      recommendedQuantity: [
        { ingredient: same("Apple"), qty: same("1 medium") },
        { ingredient: t("Raisins", "ఎండు ద్రాక్ష"), qty: same("5") },
      ],
      nutritionalBenefits: [
        { ingredient: same("Apple"), benefits: [{ benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" }] },
      ],
    ...
    lunch: {
      name: t("Chapati, Paneer Capsicum Curry", "చపాతీ, పనీర్ క్యాప్సికమ్ కూర"),
      imageUrl: imgChapatiPaneerCapsicumCurry,
      tips: t("Use less oil and keep the portion as given.", "Oil తక్కువగా వాడి given portion లో తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Chapati", "చపాతీ"), qty: same("2 small") },
        { ingredient: same("Curry"), qty: same("1 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Paneer", "పనీర్"), benefits: [{ benefitLabel: t("Muscle Health", "Muscle health ని పెంచుతుంది"), iconKey: "muscle-health" }] },
        // Sheet's Telugu benefit cell for capsicum translates to "Immunity" rather than
        // "Antioxidant Protection" — an authoring mismatch in the source, transcribed as-is.
        { ingredient: t("Capsicum", "క్యాప్సికమ్"), benefits: [{ benefitLabel: t("Antioxidant Protection", "Immunity ని పెంచుతుంది"), iconKey: "healthy-food" }] },
      ],
      groceryListAvailable: true,
    },
    eveningSnack: {
      name: t("Jowar Murmura Mix", "జొన్న ముర్మురా మిక్స్"),
      imageUrl: imgJowarMurmuraMix,
      precautions: t(
        "Keep the portion to 1 medium bowl and avoid adding fried toppings.",
        "1 medium bowl మాత్రమే తీసుకుని, fried toppings add చేయకండి."
      ),
      recommendedQuantity: [{ ingredient: same("Jowar Mix"), qty: same("1 medium bowl") }],
      nutritionalBenefits: [
        { ingredient: t("Jowar", "జొన్నలు"), benefits: [{ benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" }] },
      ],
      groceryListAvailable: true,
    },
    dinner: {
      name: t("Multi Millet Khichdi", "Multi మిల్లెట్ కిచిడీ"),
      imageUrl: imgMultiMilletKhichdi,
      tips: t(
        "Keep the portion as given and add more vegetables where possible.",
        "Given portion లో తీసుకుని వీలైతే vegetables ఎక్కువగా add చేసుకోండి."
      ),
      recommendedQuantity: [{ ingredient: same("Kichidi"), qty: same("1 medium cup") }],
      nutritionalBenefits: [
        { ingredient: t("Millet", "మిల్లెట్స్"), benefits: [
          { benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" },
          { benefitLabel: t("Manages Blood Sugar levels", "Blood sugar levels ని manage చేస్తుంది."), iconKey: "sugar-cubes" },
    ...
    nightDrink: {
      name: t("Fennel Tea", "సోంపు టీ"),
      imageUrl: imgFennelTea2608,
      tips: t("Boil 1 tsp fennel seeds in 1 cup water and take it warm.", "1 tsp సోంపు గింజలను 1 cup water లో boil చేసి warm గా తీసుకోండి."),
      precautions: t("Do not add sugar or honey", "Sugar లేదా honey add చేయకండి,"),
      recommendedQuantity: [
        { ingredient: same("Fennel Seeds"), qty: same("1 tsp") },
        { ingredient: t("Water", "గోరువెచ్చని నీరు"), qty: same("1 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Fennel Tea", "సోంపు టీ"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
      ],
      groceryListAvailable: true,
    },
  },
  "2026-08-27": {
    earlyMorning: {
      name: t("Mixed Seeds (Chia, Pumpkin, Sunflower)", "మిక్స్‌డ్ సీడ్స్ (చియా, గుమ్మడి, సన్‌ఫ్లవర్)"),
      imageUrl: imgMixedSeedsChiaPumpkinSunflower,
      items: [{ label: same("2 tbsp Total") }],
      tips: t("Soak the seeds in the night and take in the morning.", "Seeds soak చేసి morning తీసుకోండి."),
      recommendedQuantity: [{ ingredient: t("Mixed Seeds", "Seeds"), qty: same("2 tbsp total") }],
      nutritionalBenefits: [
        // Sheet's Telugu benefit cell for sunflower seeds translates to "Metabolism" rather
        // than "Antioxidant Protection" — an authoring mismatch in the source, transcribed as-is.
        { ingredient: t("Sunflower Seeds", "Sunflower గింజలు"), benefits: [{ benefitLabel: t("Antioxidant Protection", "Metabolism ని పెంచుతుంది"), iconKey: "healthy-food" }] },
    ...
    postYogaDrink: {
      name: t("Cucumber, Mint Juice", "కీరదోసకాయ, పుదీనా Juice"),
      imageUrl: imgCucumberMintJuice,
      tips: t("Take it fresh without sugar or honey.", "Fresh గా sugar లేదా honey లేకుండా తీసుకోండి."),
      recommendedQuantity: [{ ingredient: same("Juice"), qty: same("1 small glass") }],
      nutritionalBenefits: [
        { ingredient: t("Cucumber", "కీరదోసకాయ"), benefits: [
    ...
    breakfast: {
      name: t("Carrot Dosa, Mint Chutney", "క్యారెట్ దోస, పుదీనా చట్నీ"),
      imageUrl: imgCarrotDosaMintChutney,
      tips: t("Use less oil and keep the portion as given.", "Oil తక్కువగా వాడి given portion లో తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Dosa", "దోస"), qty: same("2 small") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
    ...
    morningSnack: {
      name: t("Apple, Flax Seeds", "Apple, అవిసె గింజలు"),
      imageUrl: imgAppleFlaxSeeds,
      items: [{ label: same("1 Medium Apple") }, { label: same("1 tsp Flax Seeds") }],
      precautions: t("For diabetes, 1/2 apple is enough avoid honey", "Diabetes ఉన్నవారు 1/2 Apple తీసుకుని honey avoid చేయండి."),
      recommendedQuantity: [
        { ingredient: same("Apple"), qty: same("1 medium") },
        { ingredient: same("Flax"), qty: same("1 tsp") },
      ],
      nutritionalBenefits: [
        { ingredient: same("Apple"), benefits: [{ benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" }] },
      ],
    ...
    lunch: {
      name: t("Jowar Khichdi, Homemade Fryums, Curd", "జొన్న కిచిడీ, homemade వడియాలు, పెరుగు"),
      imageUrl: imgJowarKhichdiHomemadeFryumsCurd,
      precautions: t(
        "For diabetes, keep cooked rice/grain around 150 g; for BP, keep salt low.",
        "Diabetes ఉన్నవారు cooked rice/grain సుమారు 150 g వరకే తీసుకోండి; BP ఉన్నవారు salt తక్కువగా ఉంచండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Jowar Khichdi, Homemade Fryums, Curd", "జొన్న కిచిడీ, homemade వడియాలు, పెరుగు"), qty: same("1 medium cup") },
        { ingredient: same("Fryums"), qty: same("4-5") },
        { ingredient: t("Curd", "పెరుగు"), qty: same("3 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Jowar", "జొన్నలు"), benefits: [{ benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" }] },
    ...
    eveningSnack: {
      name: t("Roasted Makhana", "వేపిన మఖానా"),
      imageUrl: imgRoastedMakhana,
      items: [{ label: same("1 Cup") }],
      precautions: t(
        "For BP, choose lightly salted or unsalted makhana and avoid packaged masala varieties.",
        "BP ఉన్నవారు lightly salted లేదా unsalted makhana తీసుకోండి"
      ),
      recommendedQuantity: [{ ingredient: t("Makhana", "మఖానా"), qty: same("1 cup") }],
      nutritionalBenefits: [
        { ingredient: t("Makhana", "మఖానా"), benefits: [{ benefitLabel: t("Bone Health", "Bone health కి మంచిది"), iconKey: "dog-bone" }] },
      ],
      groceryListAvailable: true,
    ...
    dinner: {
      name: t("Mushroom Roll", "మష్రూమ్ రోల్"),
      imageUrl: imgMushroomRoll,
      tips: t("Use less oil and keep the portion as given.", "Oil తక్కువగా వాడి given portion లో తీసుకోండి."),
      recommendedQuantity: [{ ingredient: same("Roll"), qty: same("1 medium") }],
      nutritionalBenefits: [
        // Sheet's Telugu benefit cell for mushroom translates to "Hydration" rather than
        // "Antioxidant Protection" — an authoring mismatch in the source, transcribed as-is.
        { ingredient: t("Mushroom", "మష్రూమ్"), benefits: [
          { benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" },
          { benefitLabel: t("Antioxidant Protection", "Body ని Hydrated గా ఉంచుతుంది"), iconKey: "healthy-food" },
        ] },
      ],
      groceryListAvailable: true,
    },
    nightDrink: {
      name: t("Warm Nutmeg Milk", "జాజికాయ వేసిన వేడి పాలు"),
      imageUrl: imgWarmNutmegMilk2708,
      precautions: t("Do not use more than the tiny pinch nutmeg.", "1 pinch కంటే ఎక్కువ జాజికాయ powder వాడకండి."),
      recommendedQuantity: [
        { ingredient: t("Milk", "పాలు"), qty: same("1 cup") },
        { ingredient: t("Nutmeg", "జాజికాయ"), qty: same("a tiny pinch") },
  ...
  "2026-08-28": {
    earlyMorning: {
      name: t("4 Almonds, 4 Black Raisins", "4 బాదం, 4 నల్ల ఎండు ద్రాక్ష"),
      imageUrl: img4Almonds4BlackRaisins,
      items: [{ label: same("4 Almonds") }, { label: same("4 Black Raisins") }],
      tips: t("Soak where mentioned and take in the morning.", "Mention చేసినవి soak చేసి morning తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Almonds", "బాదం"), qty: same("4") },
        { ingredient: t("Raisins", "ఎండు ద్రాక్ష"), qty: same("4") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Almonds", "బాదం"), benefits: [
          { benefitLabel: t("Brain Health", "Brain కి మంచిది"), iconKey: "brain-health" },
    ...
    postYogaDrink: {
      name: same("Tender Coconut Water"),
      imageUrl: imgTenderCoconutWater2808,
      tips: t("Take 1 glass fresh tender coconut water.", "1 glass fresh కొబ్బరి నీళ్లు తీసుకోండి."),
      precautions: t(
        "If you have diabetes, keep the portion to 1 glass",
        "Diabetes ఉన్నవారు 1 glass వరకే తీసుకోండి."
      ),
      recommendedQuantity: [{ ingredient: t("Tender Coconut Water", "కొబ్బరి నీరు"), qty: same("1 glass") }],
      nutritionalBenefits: [
        { ingredient: t("Coconut Water", "కొబ్బరి నీళ్లు"), benefits: [
    ...
    breakfast: {
      // Schedule tab's Telugu name is a single phrase, not comma-split like the English —
      // transcribed as-authored, not split to mirror the English structure.
      name: t("Vermicelli Upma, Vegetables", "వెజిటబుల్స్‌తో సేవయ్య ఉప్మా"),
      imageUrl: imgVermicelliUpmaVegetables,
      tips: t(
        "Keep the portion as given and add more vegetables where possible.",
        "Given portion లో తీసుకుని వీలైతే vegetables ఎక్కువగా add చేసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Vermicelli Upma, Vegetables", "వెజిటబుల్స్‌తో సేవయ్య ఉప్మా"), qty: same("1 medium bowl") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Mixed Vegetables", "Mixed వెజిటబుల్స్"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
    ...
    lunch: {
      name: t("Steamed Rice, Gongura Pappu, Beetroot Curry, Curd", "అన్నం, గోంగూర పప్పు, బీట్‌రూట్ కూర, పెరుగు"),
      imageUrl: imgSteamedRiceGonguraPappuBeetrootCurryCurd,
      precautions: t("For diabetes, keep cooked rice/grain around 150 g.", "Diabetes ఉన్నవారు cooked rice/grain సుమారు 150 g వరకే తీసుకోండి."),
      nutritionalBenefits: [
        // Sheet's Telugu benefit cell for gongura translates to "Immunity", matching neither
        // English benefit — transcribed as-authored (2nd item); 1st item has no Telugu at all.
        { ingredient: t("Gongura", "గోంగూర"), benefits: [
          { benefitLabel: same("Better Digestion"), iconKey: "stomach", visibleLanguages: ["English"] },
          { benefitLabel: t("Antioxidant Protection", "Immunity ని పెంచుతుంది"), iconKey: "healthy-food" },
        ] },
      ],
      groceryListAvailable: true,
    ...
    eveningSnack: {
      name: t("Sprouts Patties", "మొలకల Patties"),
      imageUrl: imgSproutsPatties,
      tips: t("Use less oil and keep the portion as given.", "Oil తక్కువగా వాడి given portion లో తీసుకోండి."),
      precautions: t("If you have gas or bloating, start with a smaller portion.", "Gas లేదా bloating ఉంటే చిన్న portion తో start చేయండి."),
      recommendedQuantity: [{ ingredient: same("Patties"), qty: same("2 medium") }],
      nutritionalBenefits: [
        { ingredient: t("Sprouts", "మొలకలు"), benefits: [
          { benefitLabel: t("Protein-Rich", "Protein ఎక్కువగా ఉంటుంది"), iconKey: "muscle-health" },
          { benefitLabel: t("Healthy Metabolism", "Metabolism ని పెంచుతుంది"), iconKey: "healthy-eating" },
    ...
    dinner: {
      name: t("Mint Rice Bowl, Carrot Beet Raita", "పుదీనా రైస్  & క్యారెట్ బీట్ రాయితా"),
      imageUrl: imgMintRiceBowlCarrotBeetRaita,
      precautions: t(
        "For diabetes, keep cooked rice/grain around 150 g; for BP, keep salt low.",
        "Diabetes ఉన్నవారు cooked rice/grain సుమారు 150 g వరకే తీసుకోండి; BP ఉన్నవారు salt తక్కువగా ఉంచండి."
      ),
    ...
    nightDrink: {
      name: t("Coriander Seed Tea", "ధనియాల గింజల టీ"),
      imageUrl: imgCorianderSeedTea2808,
      tips: t("Take it warm without sugar.", "Warm గా sugar లేకుండా తీసుకోండి."),
      recommendedQuantity: [{ ingredient: same("Tea"), qty: same("1 cup") }],
      nutritionalBenefits: [
        { ingredient: t("Coriander Seed Tea", "ధనియాలు"), benefits: [
          { benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" },
          { benefitLabel: same("Antioxidant Protection"), iconKey: "healthy-food", visibleLanguages: ["English"] },
        ] },
      ],
  ...
  "2026-08-29": {
    earlyMorning: {
      name: t("Pumpkin, Sunflower Seeds", "గుమ్మడి గింజలు, Sunflower గింజలు"),
      imageUrl: imgPumpkinSunflowerSeeds2908,
      items: [{ label: same("2 tbsp Total") }],
      tips: t("Soak where mentioned and take in the morning.", "Mention చేసినవి soak చేసి morning తీసుకోండి."),
      recommendedQuantity: [{ ingredient: same("Seeds"), qty: same("2 tbsp total") }],
      nutritionalBenefits: [
    ...
    postYogaDrink: {
      name: t("Soaked Chia Seeds, Tender Coconut Water", "నానబెట్టిన చియా గింజలు, కొబ్బరి నీళ్లు"),
      imageUrl: imgSoakedChiaSeedsTenderCoconutWater,
      precautions: t("For diabetes, avoid sugar or honey", "Diabetes ఉన్నవారు sugar లేదా honey avoid చేయండి"),
      recommendedQuantity: [
        { ingredient: same("Chia"), qty: same("1 tbsp") },
        { ingredient: t("Coconut Water", "కొబ్బరి నీళ్లు"), qty: same("1 glass") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Coconut Water", "కొబ్బరి నీళ్లు"), benefits: [
          { benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" },
    ...
    breakfast: {
      name: t("Oats, Curd Bowl with Nuts", "నట్స్‌తో ఓట్స్, పెరుగు బౌల్"),
      imageUrl: imgOatsCurdBowlWithNuts,
      precautions: t("For diabetes, avoid sugar or honey.", "Diabetes ఉన్నవారు sugar లేదా honey avoid చేయండి;"),
      recommendedQuantity: [
        { ingredient: t("Oats, Curd Bowl with Nuts", "నట్స్‌తో ఓట్స్, పెరుగు బౌల్"), qty: same("1 medium bowl") },
        { ingredient: t("Curd", "పెరుగు"), qty: same("1/2 cup") },
        { ingredient: same("Nuts"), qty: same("1 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Oats", "ఓట్స్"), benefits: [
          { benefitLabel: t("Manages Blood Sugar levels", "Blood sugar levels ని manage చేస్తుంది."), iconKey: "sugar-cubes" },
        ...
        { ingredient: same("Curd"), benefits: [{ benefitLabel: t("Gut Health", "Gut health కి మంచిది"), iconKey: "stomach" }], visibleLanguages: ["English"] },
      ],
      groceryListAvailable: true,
    },
    morningSnack: {
    ...
    lunch: {
      name: t(
        "Rice, Mixed Dal Curry, Cucumber Boiled Peanut Salad",
        "అన్నం, మిక్స్‌డ్ దాల్ కూర, కీరదోసకాయ ఉడికించిన పల్లీ సలాడ్"
      ),
      imageUrl: imgRiceMixedDalCurryCucumberBoiledPeanutSalad2908,
      precautions: t(
        "For diabetes, keep cooked rice/grain around 150 g; for BP, keep salt low.",
        "Diabetes ఉన్నవారు cooked rice/grain సుమారు 150 g వరకే తీసుకోండి; BP ఉన్నవారు salt తక్కువగా ఉంచండి."
      ),
    ...
    eveningSnack: {
      name: t("Paneer Cubes, Pepper", "పనీర్ cubes, మిరియాలు"),
      imageUrl: imgPaneerCubesPepper2908,
      items: [{ label: same("30–40 g") }],
      tips: t("Use less oil and keep the portion as given.", "Oil తక్కువగా వాడి given portion లో తీసుకోండి."),
      recommendedQuantity: [{ ingredient: t("Paneer", "పనీర్"), qty: same("30-40 g") }],
      nutritionalBenefits: [
    ...
    dinner: {
      // Sheet's schedule tab gives the English dish name with a trailing space — transcribed
      // verbatim.
      name: t("Curd Poha ", "పెరుగు అటుకులు"),
      imageUrl: imgCurdPoha,
      tips: t(
        "Keep the portion as given and add more vegetables where possible.",
        "Given portion లో తీసుకుని వీలైతే vegetables ఎక్కువగా add చేసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Curd Poha ", "పెరుగు అటుకులు"), qty: same("1 medium bowl") },
        { ingredient: t("Curd", "పెరుగు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Curd", "పెరుగు"), benefits: [{ benefitLabel: t("Gut Health", "Gut health కి మంచిది"), iconKey: "stomach" }] },
    ...
    nightDrink: {
      name: t("Ajwain Tea", "వాము టీ"),
      imageUrl: imgAjwainTea2908,
      tips: t("Take it warm without sugar.", "Warm గా sugar లేకుండా తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Water", "గోరువెచ్చని నీరు"), qty: same("1 cup") },
        { ingredient: same("Ajwain"), qty: same("1 tsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Ajwain Tea", "వాము టీ"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
      ],
      groceryListAvailable: true,
    },
  },
  "2026-08-30": {
    earlyMorning: {
      name: t("3 Pistachios, 5 Gold Raisins", "3 పిస్తా, 5 Golden ఎండు ద్రాక్ష"),
      imageUrl: img3Pistachios5GoldRaisins,
      items: [{ label: same("3 Pistachios") }, { label: same("5 Gold Raisins") }],
      precautions: t("For diabetes, keep the portion as given.", "Diabetes ఉన్నవారు given portion లోనే తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Pistachios", "పిస్తా"), qty: same("3") },
        { ingredient: t("Raisins", "ఎండు ద్రాక్ష"), qty: same("5") },
      ],
    ...
    postYogaDrink: {
      name: t("Coriander Lemon Buttermilk", "కొత్తిమీర నిమ్మ మజ్జిగ"),
      imageUrl: imgCorianderLemonButtermilk,
      tips: t(
        "Prepare the buttermilk thin by adding enough water, and avoid making it too thick.",
        "Buttermilk ఎక్కువ నీళ్లు కలిపి పలుచగా చేసుకుని తీసుకోండి; మరీ చిక్కగా ఉండకుండా చూసుకోండి."
      ),
      recommendedQuantity: [{ ingredient: same("Buttermilk"), qty: same("1 glass") }],
      nutritionalBenefits: [
        { ingredient: t("Curd", "పెరుగు"), benefits: [{ benefitLabel: t("Gut Health", "Gut health కి మంచిది"), iconKey: "stomach" }] },
      ],
      groceryListAvailable: true,
    ...
    breakfast: {
      name: t("Foxtail millet Pongal, Tomato Chutney", "కొర్ర పొంగలి, టమాటా చట్నీ"),
      imageUrl: imgFoxtailMilletPongalTomatoChutney,
      tips: t(
        "Keep the portion as given and add more vegetables where possible.",
        "Given portion లో తీసుకుని వీలైతే vegetables ఎక్కువగా add చేసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Foxtail millet Pongal, Tomato Chutney", "కొర్ర పొంగలి, టమాటా చట్నీ"), qty: same("1 medium bowl") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Millet", "మిల్లెట్స్"), benefits: [
    ...
    lunch: {
      name: t("Rice, Ginger Rasam, Paneer Veg Curry", "అన్నం, అల్లం రసం, పనీర్ కూర"),
      imageUrl: imgRiceGingerRasamPaneerVegCurry,
      tips: t(
        "Keep the portion as given and add more vegetables where possible.",
        "Given portion లో తీసుకుని వీలైతే vegetables ఎక్కువగా add చేసుకోండి."
      ),
    ...
    eveningSnack: {
      name: t("Boiled Peanuts, Black Chana, Veggies", "ఉడికించిన పల్లీలు, నల్ల శనగలు, వెజిటబుల్స్"),
      imageUrl: imgBoiledPeanutsBlackChanaVeggies,
      precautions: t("For thyroid concerns, keep peanuts to 1–2 tbsp.", "Thyroid ఉన్నవారు peanuts ని 1–2 tbsp వరకు ఉంచండి."),
      recommendedQuantity: [
        { ingredient: t("Peanuts", "పల్లీలు"), qty: same("1/2 cup") },
        { ingredient: same("Chana"), qty: same("1/2 cup") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Peanuts", "పల్లీలు"), benefits: [{ benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" }] },
    ...
    dinner: {
      name: t("Chickpea, Mint Spread Roll", "శనగ, పుదీనా spread roll"),
      imageUrl: imgChickpeaMintSpreadRoll,
      tips: t(
        "Use 1 medium homemade roll with plenty of vegetables and chickpea spread.",
        "1 medium homemade roll లో chickpea spread & vegetables ఎక్కువగా పెట్టుకోండి."
      ),
      precautions: t(
        "For PCOS or diabetes, avoid refined-flour wraps where possible.",
        "PCOS లేదా Diabetes ఉన్నవారు maida wraps వీలైనంత వరకు avoid చేయండి."
      ),
      recommendedQuantity: [{ ingredient: same("Roll"), qty: same("1 medium") }],
      nutritionalBenefits: [
        { ingredient: t("Boiled Chana", "ఉడికించిన శనగలు"), benefits: [
    ...
    nightDrink: {
      name: t("Chamomile Tea", "Chamomile  టీ"),
      imageUrl: imgChamomileTea,
      tips: t("Take 1 cup chamomile tea without sugar.", "1 cup Chamomile  టీని sugar లేకుండా తీసుకోండి."),
      precautions: t("Do not use it as a replacement for water.", "Water కి బదులుగా దీనినే ఎక్కువగా తీసుకోకండి."),
      recommendedQuantity: [{ ingredient: same("Tea"), qty: same("1 cup") }],
      nutritionalBenefits: [
        { ingredient: same("Chamomile"), benefits: [{ benefitLabel: t("Relaxation", "Relax గా ఉంటుంది."), iconKey: "meditation" }] },
      ],
      groceryListAvailable: true,
    },
  },
"2026-08-31": {
    earlyMorning: {
      name: t("Watermelon Seeds & Chia Seeds", "పుచ్చకాయ గింజలు , చియా గింజలు"),
      imageUrl: imgM148Meal,
      items: [{ label: same("2 tbsp Total") }],
      tips: t("Take 2 tbsp seeds; soak chia well before taking.", "2 tbsp seeds తీసుకుని chia ని బాగా soak చేయండి."),
      precautions: t(
        "Keep the total seed portion to 2 tbsp and drink enough water.",
        "Total seeds ని 2 tbsp వరకే ఉంచి సరిపడా water తాగండి."
      ),
      recommendedQuantity: [{ ingredient: same("Seeds"), qty: same("2 tbsp total") }],
      nutritionalBenefits: [
        { ingredient: t("Watermelon Seeds", "పుచ్చకాయ గింజలు"), benefits: [
    ...
    breakfast: {
      name: t("Moong Dal Dosa with Chutney", "పెసరపప్పు దోస , చట్నీ"),
      imageUrl: imgM144Meal,
      tips: t(
        "Take 2 medium moong dal dosa with about 2 tbsp chutney. Use less oil.",
        "2 medium పెసరపప్పు దోసతో సుమారు 2 tbsp chutney తీసుకోండి. Oil తక్కువగా వాడండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Dosa", "దోస"), qty: same("2 medium") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Moong", "పెసరపప్పు"), benefits: [
    ...
    morningSnack: {
      ...
      imageUrl: imgM27Meal,
      items: [{ label: same("1 Medium Fruit") }],
      tips: t("Take 1 medium guava as a whole fruit.", "1 medium జామపండును whole fruit గా తీసుకోండి."),
      precautions: t("If you have diabetes, take 1 medium guava only", "Diabetes ఉన్నవారు 1 medium జామపండు వరకే  తీసుకోకండి."),
      recommendedQuantity: [{ ingredient: t("Guava", "జామపండు"), qty: same("1 medium") }],
      nutritionalBenefits: [
        { ingredient: t("Guava", "జామపండు"), benefits: [
          { benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" },
          { benefitLabel: t("Gut Health", "Gut health కి మంచిది"), iconKey: "stomach" },
          { benefitLabel: t("Healthy Blood Sugar", "Blood sugar levels ని manage చేస్తుంది."), iconKey: "sugar-cubes" },
          { benefitLabel: same("Antioxidant Protection"), iconKey: "healthy-food", visibleLanguages: ["English"] },
          { benefitLabel: same("Keeps You Full Longer"), iconKey: "happy", visibleLanguages: ["English"] },
        ] },
      ],
      groceryListAvailable: true,
    },
    lunch: {
      name: t("Steamed Rice, Amaranth Dal, Ivy gourd Curry & Curd", "అన్నం , తోటకూర పప్పు , దొండకాయ కూర , పెరుగు"),
      imageUrl: imgM145Meal,
      tips: t(
        "Adjust rice based on hunger and activity; keep dal and vegetables generous.",
        "మీ ఆకలి, activity బట్టి rice portion adjust చేసుకోండి; dal & vegetables ఎక్కువగా తీసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: t("Dal", "పప్పు"), qty: same("1 cup") },
      ...
      nutritionalBenefits: [
        { ingredient: same("Rice"), benefits: [{ benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" }] },
        { ingredient: t("Amaranth", "తోటకూర"), benefits: [
          { benefitLabel: t("Improves Nutrient Absorption", "Immunity ని పెంచుతుంది"), iconKey: "nutrient-absorption" },
          { benefitLabel: t("Supports Hemoglobin", "Hemoglobin ని పెంచుతుంది"), iconKey: "hemoglobin" },
        ] },
      ],
      groceryListAvailable: true,
    ...
    eveningSnack: {
      name: t("Ash Gourd Soup", "బూడిద గుమ్మడికాయ soup"),
      imageUrl: imgM146Meal,
      precautions: t(
        "For BP, avoid packaged soup powders and keep salt low.",
        "BP ఉన్నవారు packaged soup powders avoid చేసి salt తక్కువగా ఉంచండి."
      ),
      recommendedQuantity: [{ ingredient: same("Soup"), qty: same("1 medium bowl") }],
      nutritionalBenefits: [
        { ingredient: t("Ash Gourd", "బూడిద గుమ్మడికాయ"), benefits: [
    ...
    dinner: {
      name: t("Chickpea Salad (Curd, Lemon & Cucumber)", "శనగ సలాడ్ (పెరుగు , నిమ్మరసం , కీరదోసకాయ)"),
      imageUrl: imgM143Meal,
      precautions: t("If you have gas or bloating, start with a smaller portion.", "Gas లేదా bloating ఉంటే చిన్న portion తో start చేయండి."),
      recommendedQuantity: [
        { ingredient: same("Chickpeas"), qty: same("1 cup") },
        { ingredient: t("Curd", "పెరుగు"), qty: same("1/2 cup") },
        { ingredient: t("Cucumber", "కీరదోసకాయ"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Boiled Chana", "ఉడికించిన శనగలు"), benefits: [
          { benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" },
  ...
  "2026-09-01": {
    ...
    breakfast: {
      name: t("Adai Dosa with Coconut Chutney", "అడై దోస , కొబ్బరి చట్నీ"),
      imageUrl: imgM149Meal,
      tips: t(
        "Take 2 medium adai dosa with about 2 tbsp coconut chutney. Use less oil.",
        "2 medium అడై దోసతో సుమారు 2 tbsp కొబ్బరి చట్నీ తీసుకోండి. Oil తక్కువగా వాడండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Dosa", "దోస"), qty: same("2 medium") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
    ...
    lunch: {
      name: t("Jeera Rice Bowl, Mushroom Curry & Curd", "జీలకర్ర రైస్ , మష్రూమ్ కూర , పెరుగు"),
      imageUrl: imgM150Meal,
      precautions: t(
        "For diabetes, keep cooked rice to 150 g. For BP, keep salt low.",
        "Diabetes ఉన్నవారు cooked rice 150 g వరకే తీసుకోండి. BP ఉన్నవారు salt తక్కువగా ఉంచండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: same("Curry"), qty: same("1 cup") },
      ...
      nutritionalBenefits: [
        { ingredient: t("Jeera", "జీలకర్ర"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
        // Sheet's Telugu benefit cell for mushroom translates to "Hydration" rather than
        // "Antioxidant Protection" — an authoring mismatch in the source, transcribed as-is.
        { ingredient: t("Mushroom", "మష్రూమ్"), benefits: [
          { benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" },
    ...
    eveningSnack: {
      name: t("Sprouts Chaat", "మొలకల చాట్"),
      imageUrl: imgM151Meal,
      tips: t(
        "Use lightly steamed sprouts with cucumber, tomato and lemon.",
        "Lightly steamed sprouts కి cucumber, tomato & lemon add చేసుకుని 1 cup తీసుకోండి."
      ),
      precautions: t(
        "If you have gas or bloating, start with 1/2 cup and use well-steamed sprouts.",
        "Gas లేదా bloating ఉంటే 1/2 cup తో start చేసి sprouts ని బాగా steam చేయండి."
      ),
      recommendedQuantity: [{ ingredient: same("Chat"), qty: same("1 cup") }],
      nutritionalBenefits: [
        { ingredient: t("Sprouts", "మొలకలు"), benefits: [
          { benefitLabel: t("Protein-Rich", "Protein ఎక్కువగా ఉంటుంది"), iconKey: "muscle-health" },
          { benefitLabel: t("Healthy Metabolism", "Metabolism ని పెంచుతుంది"), iconKey: "healthy-eating" },
    ...
    dinner: {
      name: t("Pearl millet Khichdi", "సజ్జల కిచిడీ"),
      imageUrl: imgM152Meal,
      tips: t("Take 1 medium bowl millet khichdi with vegetables and dal.", "1 medium bowl సజ్జల కిచిడీని vegetables & dal తో తీసుకోండి."),
      precautions: t(
        "For diabetes, keep the cooked millet portion around 150 g and add more vegetables.",
        "Diabetes ఉన్నవారు cooked millet portion సుమారు 150 g వరకే ఉంచి vegetables ఎక్కువగా తీసుకోండి."
      ),
      recommendedQuantity: [{ ingredient: same("Khichidi"), qty: same("1 medium bowl") }],
      nutritionalBenefits: [
        { ingredient: t("Millet", "మిల్లెట్స్"), benefits: [
          { benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" },
          { benefitLabel: t("Manages Blood Sugar levels", "Blood sugar levels ని manage చేస్తుంది."), iconKey: "sugar-cubes" },
  ...
  "2026-09-02": {
    earlyMorning: {
      name: t("Drumstick leaf Water", "మునగాకు నీళ్లు"),
      imageUrl: imgM153Meal,
      items: [{ label: same("1 Glass") }],
      tips: t("Use clean fresh moringa leaves and take 1 glass warm water.", "Fresh clean మునగాకు ఉపయోగించి 1 glass warm water తీసుకోండి."),
      recommendedQuantity: [{ ingredient: t("Water", "గోరువెచ్చని నీరు"), qty: same("1 glass") }],
      nutritionalBenefits: [
        { ingredient: t("Drumstick Leaves", "మునగాకు"), benefits: [
          { benefitLabel: t("Supports Hemoglobin", "Hemoglobin ని పెంచుతుంది"), iconKey: "hemoglobin" },
          { benefitLabel: t("Healthy Blood Sugar", "Blood sugar levels ని manage చేస్తుంది."), iconKey: "sugar-cubes" },
        ] },
      ],
    ...
    breakfast: {
      name: t("Jowar Ravva Upma with Vegetables", "జొన్న రవ్వ ఉప్మా , కూరగాయలు"),
      imageUrl: imgM154Meal,
      tips: t(
        "Take 1 medium bowl jowar ravva upma with at least 1/2 cup vegetables.",
        "1 medium bowl జొన్న రవ్వ ఉప్మాలో కనీసం 1/2 cup vegetables add చేసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: same("Upma"), qty: same("1 medium bowl") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
    ...
    lunch: {
      name: t("Chapati, Kaju Tomato Curry", "చపాతీ , జీడిపప్పు టమాటా కూర"),
      imageUrl: imgM155Meal,
      tips: t("Take 2 small chapati with 1 cup curry and use less oil.", "2 small చపాతీలతో 1 cup curry తీసుకుని oil తక్కువగా వాడండి."),
      recommendedQuantity: [
        { ingredient: t("Chapati", "చపాతీ"), qty: same("2 small") },
        { ingredient: same("Curry"), qty: same("1 cup") },
      ],
    ...
    eveningSnack: {
      name: t("Boiled Sweet Potato with Pepper", "ఉడికించిన చిలగడదుంప , మిరియాలు"),
      imageUrl: imgM156Meal,
      tips: t(
        "Take 1 small–medium boiled sweet potato with a little pepper.",
        "1 small–medium ఉడికించిన చిలగడదుంపకు కొద్దిగా pepper add చేసుకుని తీసుకోండి."
      ),
      precautions: t(
        "For diabetes, keep it to one small–medium piece and avoid jaggery or sugar.",
        "Diabetes ఉన్నవారు one small–medium piece వరకే తీసుకుని jaggery  add చేయకండి."
      ),
      recommendedQuantity: [{ ingredient: t("Sweet Potato", "చిలగడదుంప"), qty: same("1 small-medium") }],
      nutritionalBenefits: [
        { ingredient: t("Sweet Potato", "చిలగడదుంప"), benefits: [
          { benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" },
          { benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" },
    ...
    dinner: {
      name: t("Vegetable Uthappam & Tomato Chutney", "Vegetable ఉత్తప్పం & టమాటా చట్నీ"),
      imageUrl: imgM30Meal,
      tips: t(
        "Take 1 medium vegetable uthappam with about 2 tbsp tomato chutney.",
        "1 medium vegetable ఉత్తప్పంతో సుమారు 2 tbsp టమాటా చట్నీ తీసుకోండి."
      ),
      precautions: t(
        "For diabetes or PCOS, keep oil to about 1–2 tsp for the serving.",
        "Diabetes లేదా PCOS ఉన్నవారు మొత్తం serving కి 1–2 tsp oil వరకే వాడండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Uthappam", "ఉత్తప్పం"), qty: same("1 medium") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Mixed Vegetables", "Mixed వెజిటబుల్స్"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
  ...
  "2026-09-03": {
    earlyMorning: {
      name: t("Soaked Pumpkin & Sunflower Seeds", "గుమ్మడి గింజలు , Sunflower గింజలు"),
      imageUrl: imgM132Meal,
      items: [{ label: same("2 tbsp Total") }],
      tips: t("Soak where mentioned and take in the morning.", "Mention చేసినవి soak చేసి morning తీసుకోండి."),
      recommendedQuantity: [{ ingredient: same("Seeds"), qty: same("2 tbsp total") }],
      nutritionalBenefits: [
    ...
    postYogaDrink: {
      name: t("Soaked Chia Seeds & Amla Water", "నానబెట్టిన చియా గింజలు , ఉసిరి నీళ్లు"),
      imageUrl: imgM157Meal,
      tips: t(
        "Soak 1 tbsp chia well and add to 1 glass amla water without sugar.",
        "1 tbsp chia ని బాగా soak చేసి 1 glass amla water లో add చేసుకోండి; sugar వేయకండి."
      ),
      recommendedQuantity: [
        { ingredient: same("Soaked Chia"), qty: same("1 tbsp") },
        { ingredient: t("Amla Water", "ఉసిరి నీళ్లు"), qty: same("1 glass") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Amla Water", "ఉసిరి నీళ్లు"), benefits: [{ benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" }] },
      ],
    ...
    // Sheet's Daily Data row for this date+slot points to meal_id M26 ("Paneer/Egg Bhurji &
    // Phulka"), not M158 ("Paneer Vegetable Bhurji & 2 Phulka") — this slot was originally
    // transcribed against the wrong Meals Library row; corrected to M26 (name/tips/
    // precautions/benefits below all match M26's row). Image still pending: M26's asset
    // hasn't been fetched from the bucket yet, so `imageUrl` still points at the old M158
    // photo until that's done — see TODO below.
    breakfast: {
      name: t("Paneer/Egg Bhurji & Phulka", "పనీర్/Egg భుర్జీ & ఫుల్కా"),
      // TODO: swap for the real M26 photo once fetched from gs://diet-tabs-images/meal-images/M26.png
      imageUrl: imgM158Meal,
      tips: t(
        "Take 1 cup vegetable paneer/egg bhurji with 1 small phulka.",
        "1 cup vegetable paneer/egg bhurji తో 1 small phulka తీసుకోండి."
      ),
      precautions: t(
        "Keep paneer/egg to about 50–75 g and oil to about 2 tsp per person.",
        "Paneer/egg ని 50–75 g వరకు, oil ని ఒక్కరికి 2 tsp వరకు ఉంచండి."
      ),
      recommendedQuantity: [
        { ingredient: same("Paneer/Egg Bhurji"), qty: same("1 cup") },
        { ingredient: same("Phulka"), qty: same("1 small") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Paneer", "పనీర్"), benefits: [{ benefitLabel: t("Muscle Health", "Muscle health ని పెంచుతుంది"), iconKey: "muscle-health" }] },
        { ingredient: t("Mixed Vegetables", "Mixed వెజిటబుల్స్"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
        { ingredient: same("Egg"), benefits: [
          { benefitLabel: t("Protein-Rich", "Protein ఎక్కువగా ఉంటుంది"), iconKey: "muscle-health" },
          { benefitLabel: t("Muscle Health", "Muscle health ని పెంచుతుంది"), iconKey: "muscle-health" },
        ] },
      ],
    ...
    lunch: {
      // meal_id M159 does not exist in the sheet (numbering jumps M158 → M160) — not a
      // transcription gap on our end.
      name: t("Millet Methi Vegetable Bath & Raita", "మిల్లెట్ మెంతి వెజిటబుల్ బాత్ , రాయితా"),
      imageUrl: imgM160Meal,
      tips: t(
        "Take 1 medium cup millet vegetable bath with 1/2 cup raita.",
        "1 medium cup millet vegetable bath తో 1/2 cup raita తీసుకోండి."
      ),
      precautions: t(
        "For diabetes, keep cooked millet around 150 g. For BP, keep salt low.",
        "Diabetes ఉన్నవారు cooked millet సుమారు 150 g వరకే తీసుకోండి. BP ఉన్నవారు salt తక్కువగా ఉంచండి."
      ),
      recommendedQuantity: [
        { ingredient: same("Vegetable Bath"), qty: same("1 medium cup") },
        { ingredient: same("Raita"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Methi", "మెంతి కూర"), benefits: [{ benefitLabel: t("Reduces Cholesterol", "Cholesterol ని తగ్గిస్తుంది."), iconKey: "allergen-free" }] },
    ...
    eveningSnack: {
      name: t("Peanut Chikki", "పల్లీ చిక్కీ"),
      imageUrl: imgM161Meal,
      items: [{ label: same("1 Small Piece") }],
      tips: t(
        "Take 1 small homemade piece and keep the jaggery portion low.",
        "1 small homemade పల్లీ చిక్కీ piece తీసుకుని jaggery తక్కువగా ఉండేలా చూసుకోండి."
      ),
      precautions: t(
        "For diabetes, avoid regular jaggery chikki or take only as advised in your individual diet plan.",
        "Diabetes ఉన్నవారు regular jaggery chikki avoid చేయండి లేదా individual diet plan ప్రకారం మాత్రమే తీసుకోండి."
      ),
      recommendedQuantity: [{ ingredient: same("Chikki"), qty: same("1 small piece") }],
      nutritionalBenefits: [
        { ingredient: t("Peanuts", "పల్లీలు"), benefits: [{ benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" }] },
      ],
      groceryListAvailable: true,
    ...
    dinner: {
      ...
      name: t("Homemade Veg Fried Rice Bowl & Raita", " ఫ్రైడ్ రైస్ (Homemade) & రాయితా"),
      imageUrl: imgM162Meal,
      tips: t(
        "Use less oil and plenty of vegetables; take 1 medium cup.",
        "Oil తక్కువగా వాడి vegetables ఎక్కువగా add చేసి 1 medium cup తీసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: same("Raita"), qty: same("1/2 cup") },
  ...
  "2026-09-04": {
    earlyMorning: {
      name: t("2 Walnuts & 2 Dates (soaked)", "2 walnuts , 2 ఖర్జూరాలు"),
      imageUrl: imgM163Meal,
      items: [{ label: same("2 Walnuts") }, { label: same("2 Dates") }],
      tips: t(
        "Soak the walnuts and take them with 2 dates in the morning.",
        "Walnuts night soak చేసి morning 2 dates తో తీసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: same("Walnuts"), qty: same("2") },
        { ingredient: t("Dates", "ఖర్జూరం"), qty: same("2") },
    ...
    postYogaDrink: {
      name: t("Ginger Curry Leaves Buttermilk", "అల్లం కరివేపాకు మజ్జిగ"),
      imageUrl: imgM164Meal,
      tips: t(
        "Take 1 glass thin buttermilk with ginger and curry leaves; keep salt low.",
        "1 glass thin మజ్జిగలో అల్లం & కరివేపాకు add చేసుకుని salt తక్కువగా ఉంచండి."
      ),
      precautions: t(
        "For BP, avoid salt. If gastric issues are triggered by ginger, use less ginger.",
        "BP ఉన్నవారు  salt avoid చేయండి. Gastric issues ఉంటే ginger తక్కువగా వాడండి."
      ),
      recommendedQuantity: [{ ingredient: same("Thin Buttermilk"), qty: same("1 glass") }],
      nutritionalBenefits: [
        { ingredient: t("Ginger", "అల్లం"), benefits: [
          { benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" },
          { benefitLabel: same("Antioxidant Protection"), iconKey: "healthy-food", visibleLanguages: ["English"] },
    ...
    breakfast: {
      name: t("Ragi Dosa with Coconut Chutney", "రాగి దోస , కొబ్బరి చట్నీ"),
      imageUrl: imgM165Meal,
      tips: t(
        "Take 2 medium ragi dosa with 2 tbsp coconut chutney; use less oil.",
        "2 medium రాగి దోసతో 2 tbsp కొబ్బరి చట్నీ తీసుకోండి. Oil తక్కువగా వాడండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Dosa", "దోస"), qty: same("2 medium") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
    ...
    lunch: {
      name: t(
        "Steamed Rice, Tomato Dal, Lady finger Curry & Curd",
        "అన్నం , టమాటా పప్పు , బెండకాయ కూర , పెరుగు"
      ),
      imageUrl: imgM166Meal,
      tips: t(
        "Adjust rice based on hunger and activity; keep dal and vegetables generous.",
        "మీ ఆకలి, activity బట్టి rice portion adjust చేసుకోండి; dal & vegetables ఎక్కువగా తీసుకోండి."
      ),
      ...
      nutritionalBenefits: [
        { ingredient: same("Rice"), benefits: [{ benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" }] },
        { ingredient: t("Lady Finger", "బెండకాయ"), benefits: [
          { benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" },
          { benefitLabel: t("Improves Nutrient Absorption", "Healthy fats, Vitamin A & Vitamin K2 ఎక్కువగా ఉంటాయి"), iconKey: "nutrient-absorption", visibleLanguages: ["English"] },
        ] },
      ],
      groceryListAvailable: true,
    },
    eveningSnack: {
      name: t("Cowpea, Onion Salad with Tadaka", "అలసందలు , ఉల్లిపాయ సలాడ్"),
      imageUrl: imgM167Meal,
      precautions: t(
        "If you have gas or bloating, start with 1/2 cup and increase gradually.",
        "Gas లేదా bloating ఉంటే 1/2 cup తో start చేసి gradually increase చేయండి."
      ),
      recommendedQuantity: [
        { ingredient: same("Cooked Cowpeas"), qty: same("1 cup") },
        { ingredient: same("Salad"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Cowpea", "అలసందలు"), benefits: [
          { benefitLabel: t("Protein-Rich", "Protein ఎక్కువగా ఉంటుంది"), iconKey: "muscle-health" },
          { benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" },
        ] },
      ],
    ...
    nightDrink: {
      name: t("Ginger Jeera Tea", "అల్లం జీలకర్ర టీ"),
      imageUrl: imgM169Meal,
      tips: t("Take 1 cup warm ginger-jeera tea without sugar.", "1 cup warm అల్లం జీలకర్ర టీని sugar లేకుండా తీసుకోండి."),
      precautions: t(
        "If you have gastric irritation, keep ginger mild and stop if it causes burning.",
        "Gastric irritation ఉంటే ginger mild గా వాడి burning అయితే stop చేయండి."
      ),
      recommendedQuantity: [{ ingredient: same("Tea"), qty: same("1 cup") }],
      nutritionalBenefits: [
        { ingredient: t("Ginger", "అల్లం"), benefits: [
  ...
  "2026-09-05": {
    ...
    postYogaDrink: {
      name: t("Coriander & Lemon Detox Juice", "కొత్తిమీర , నిమ్మరసం జ్యూస్"),
      imageUrl: imgM170Meal,
      tips: t(
        "Take 1 small glass fresh coriander-lemon juice without sugar.",
        "1 small glass fresh కొత్తిమీర-నిమ్మరసం జ్యూస్ ని sugar లేకుండా తీసుకోండి."
      ),
      precautions: t(
        "If you have gastric acidity, use less lemon or avoid it if it causes irritation.",
        "Gastric acidity ఉంటే lemon తక్కువగా వాడండి లేదా irritation అయితే avoid చేయండి."
      ),
      recommendedQuantity: [{ ingredient: same("Juice"), qty: same("1 small glass") }],
      nutritionalBenefits: [
        { ingredient: t("Lemon", "నిమ్మకాయ"), benefits: [{ benefitLabel: t("Immunity", "Immunity ని పెంచుతుంది"), iconKey: "shield" }] },
    ...
    breakfast: {
      name: t("Boiled Corn & Veg Salad", "ఉడికించిన మొక్కజొన్న సలాడ్"),
      imageUrl: imgM171Meal,
      precautions: t(
        "For diabetes, keep corn to about 1/2 cup and avoid butter or sugary toppings.",
        "Diabetes ఉన్నవారు corn ని సుమారు 1/2 cup వరకే తీసుకుని butter లేదా sugary toppings avoid చేయండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Corn", "మొక్కజొన్న"), qty: same("1/2-1 cup") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Corn", "మొక్కజొన్న"), benefits: [
          { benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" },
    ...
    lunch: {
      name: t("Carrot Rice, Rajma Curry & Onion Lemon Salad", "క్యారెట్ రైస్ , రాజ్మా కూర & Salad"),
      imageUrl: imgM172Meal,
      precautions: t(
        "If you have gas, keep rajma well-cooked and start smaller.",
        "Gas ఉంటే rajma బాగా cook చేసి చిన్న portion తో start చేయండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: t("Rajma", "రాజ్మా"), qty: same("1 cup") },
        { ingredient: same("Salad"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        // Sheet lists these two ingredients in reverse order between languages (Rajma
        // first in Telugu, Rice first in English) — order transcribed per language as given.
        { ingredient: same("Rice"), benefits: [{ benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" }] },
        { ingredient: t("Rajma", "రాజ్మా"), benefits: [
          { benefitLabel: t("Protein-Rich", "Protein ఎక్కువగా ఉంటుంది"), iconKey: "muscle-health" },
          { benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" },
  ...
  // 2026-09-06 has no distinct Post Yoga Drink card — see `OMITTED_SLOTS_BY_DATE` below.
  "2026-09-06": {
    earlyMorning: {
      name: t("3 Soaked Pistachios & 2 Soaked Dates", "3 నానబెట్టిన పిస్తా , 2 నానబెట్టిన ఖర్జూరాలు"),
      imageUrl: imgM173Meal,
      items: [{ label: same("3 Pistachios") }, { label: same("2 Dates") }],
      precautions: t(
        "For diabetes, avoid dates or take only as advised in your individual diet plan.",
        "Diabetes ఉన్నవారు dates avoid చేయండి లేదా portion ప్రకారం మాత్రమే తీసుకోండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Pistachios", "పిస్తా"), qty: same("3") },
        { ingredient: t("Dates", "ఖర్జూరం"), qty: same("2") },
    ...
    breakfast: {
      name: t("Pearl Millet Malt with Nuts and Seeds", "సజ్జల మాల్ట్ , నట్స్ & సీడ్స్"),
      imageUrl: imgM174Meal,
      precautions: t(
        "For diabetes, do not add sugar/jaggery and keep the malt portion moderate.",
        "Diabetes ఉన్నవారు sugar/jaggery add చేయకుండా malt portion moderate గా ఉంచండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Pearl Millet Malt with Nuts and Seeds", "సజ్జల మాల్ట్ , నట్స్ & సీడ్స్"), qty: same("1 medium glass") },
        { ingredient: same("Nuts/Seeds"), qty: same("1 tbsp") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Millet", "మిల్లెట్స్"), benefits: [
          { benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" },
    ...
    lunch: {
      name: t("Rice, Pepper Rasam & Chana Masala Curry", "అన్నం , మిరియాల రసం , శనగ మసాలా కూర"),
      imageUrl: imgM175Meal,
      precautions: t("If you have gas, keep chana well-cooked and moderate.", "Gas ఉంటే chana బాగా cook చేసి moderate గా తీసుకోండి."),
      recommendedQuantity: [
        { ingredient: t("Rice", "అన్నం"), qty: same("1 medium cup") },
        { ingredient: t("Rasam", "రసం"), qty: same("1 cup") },
        { ingredient: same("Chana Curry"), qty: same("1 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: same("Rice"), benefits: [{ benefitLabel: t("Energy", "Energy ని ఇస్తుంది"), iconKey: "lightning-bolt" }] },
        { ingredient: t("Pepper", "మిరియాలు"), benefits: [{ benefitLabel: t("Better Digestion", "Digestion ని support చేస్తుంది"), iconKey: "stomach" }] },
    ...
    eveningSnack: {
      name: t("Salad Snack (Boiled Peanuts, Black Chana & Veggies)", "సలాడ్ స్నాక్ (ఉడికించిన పల్లీలు , నల్ల శనగలు , vegetables)"),
      imageUrl: imgM176Meal,
      precautions: t(
        "For thyroid, keep peanuts to 1–2 tbsp. If you have gas, reduce the legumes portion.",
        "Thyroid ఉన్నవారు peanuts ని 1–2 tbsp వరకు ఉంచండి. Gas ఉంటే legumes portion తగ్గించండి."
      ),
      recommendedQuantity: [
        { ingredient: same("Legumes"), qty: same("1/2 cup") },
        { ingredient: t("Vegetables", "కూరగాయలు"), qty: same("1/2 cup") },
      ],
      nutritionalBenefits: [
        { ingredient: t("Peanuts", "పల్లీలు"), benefits: [{ benefitLabel: t("Keeps You Full Longer", "ఎక్కువసేపు stomach full గా ఉంచుతుంది"), iconKey: "happy" }] },
    ...
    dinner: {
      // Sheet's English schedule cell reads "Vegetbale" (typo for "Vegetable") — transcribed
      // verbatim.
      name: t("Mixed Vegetable Uttappam, Tomato Chutney", "Mixed Vegetbale ఉత్తప్పం , టమాటా చట్నీ"),
      imageUrl: imgM177Meal,
      precautions: t(
        "For diabetes or PCOS, keep it to 2 small uttappam and avoid extra portions.",
        "Diabetes లేదా PCOS ఉన్నవారు 2 small uttappam వరకే తీసుకుని extra portion avoid చేయండి."
      ),
      recommendedQuantity: [
        { ingredient: t("Uttappam", "ఉత్తప్పం"), qty: same("2 small") },
        { ingredient: same("Chutney"), qty: same("2 tbsp") },
 ...
 * 2026-08-19, 2026-08-25, and 2026-09-06 likewise have no Post Yoga Drink card per their
 * sheet's day schedule (M2W2, M1W3, and M1W4 tabs respectively).
 */
export const OMITTED_SLOTS_BY_DATE: Partial<Record<string, MealSlotId[]>> = {
  ...
  "2026-08-25": ["postYogaDrink"],
  "2026-09-06": ["postYogaDrink"],
};
