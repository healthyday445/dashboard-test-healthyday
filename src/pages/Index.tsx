                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      {(() => {
                        ...
                        return rows.map((row, ri) => {
                          if (row.type === "here") {
                            const isZero = refCount === 0;
                            const indicatorColor = isZero ? "#D22129" : "#FEAB27"; // Darker red for visibility
                            const bgColor = isZero ? "rgba(210,33,41,0.10)" : "rgba(254,171,39,0.20)";
                            const shadowColor = isZero ? "rgba(210,33,41,0.25)" : "rgba(254,171,39,0.25)";
                            return (
                              <div key="here" style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "14px", position: "relative", zIndex: 1 }}>
                                <div style={{ flexShrink: 0, width: "33px", height: "24px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                  <div style={{ width: "12px", height: "12px", borderRadius: "50%", background: indicatorColor, boxShadow: `0 0 0 4px ${shadowColor}` }} />
                                </div>
                                <span style={{ color: isZero ? indicatorColor : "#202020", fontFamily: "Outfit", fontSize: "14px", fontWeight: 600 }}>
                                  {refCount} Referrals
                                </span>
                                <div style={{ height: "21px", borderRadius: "20px", border: `1px solid ${indicatorColor}`, background: bgColor, display: "flex", alignItems: "center", padding: "0 10px" }}>
                                  <span style={{ color: indicatorColor, fontFamily: "Outfit", fontSize: "12px", fontWeight: 600 }}>
                                    You are here
                                  </span>
                                </div>
                              </div>
