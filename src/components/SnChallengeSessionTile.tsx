...
interface SnChallengeSessionTileProps {
  ...
  titleLines: string[];
  subtitle?: string;
  /** Button text — defaults to "JOIN NOW" with the loop+play icon. SnChallengeCard's
   *  3:30-7:29 PM "View Recording" variant (Figma node 1312:3228) passes "View Recording" with
   *  no icon instead, since that button links to /recordings rather than a live session. */
  ctaLabel?: string;
  showCtaIcon?: boolean;
}
